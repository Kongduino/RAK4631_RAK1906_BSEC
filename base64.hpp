...
/* base64_to_binary:
  Description:  Converts a single byte from a base64 character to the corresponding binary value
  Parameters:   c - Base64 character (as ASCII code)
  Returns:      6-bit binary value
*/
unsigned char base64_to_binary(unsigned char c);

/* encode_base64_length:
     Description: Calculates length of base64 string needed for a given number of binary bytes
     Parameters:  input_length - Amount of binary data in bytes
     Returns:     Number of base64 characters needed to encode input_length bytes of binary data
*/
unsigned int encode_base64_length(unsigned int input_length);

/* decode_base64_length:
     Description: Calculates number of bytes of binary data in a base64 string.
                  Variant that does not use input_length no longer used within library, retained for API compatibility
     Parameters:  input - Base64-encoded null-terminated string
                  input_length (optional) - Number of bytes to read from input pointer
     Returns:     Number of bytes of binary data in input
*/
unsigned int decode_base64_length(unsigned char input[]);
unsigned int decode_base64_length(unsigned char input[], unsigned int input_length);

/* encode_base64:
     Description: Converts an array of bytes to a base64 null-terminated string
     Parameters:  input - Pointer to input data
     ...
     Returns:     Length of encoded string in bytes (not including null terminator)
*/
unsigned int encode_base64(unsigned char input[], unsigned int input_length, unsigned char output[]);

/* decode_base64:
     Description: Converts a base64 null-terminated string to an array of bytes
     Parameters:  input - Pointer to input string
                  input_length (optional) - Number of bytes to read from input pointer
                  output - Pointer to output array
     Returns:     Number of bytes in the decoded binary
*/
